  ...
  void initState() {
    availableProducts = [
      ...
      Product(
        ...
        price: 20.0,
        imgUrl:
            'https://plus.unsplash.com/premium_photo-1668618296300-e301f8d2cef9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
      ),
      Product(
        name: 'Lassagna 2',
        price: 20.0,
        imgUrl:
            'https://images.unsplash.com/photo-1551978129-b73f45d132eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=817&q=80',
      ),
      Product(
        name: 'Promo 01',
        price: 20.0,
        imgUrl:
            'https://static.phdvasia.com/br/menu/combo/desktop_thumbnail_12197709-be16-4afa-81fb-492cf7de2c8d.jpg',
      ),
      Product(
        name: 'Promo 02',
        price: 20.0,
        imgUrl:
            'https://static.phdvasia.com/br/menu/combo/desktop_thumbnail_e1138d07-c98f-4f17-8544-1fb4eb41d86c.png',
      ),
    ];
    super.initState();
  }
